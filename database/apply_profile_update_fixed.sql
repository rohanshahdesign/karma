-- Apply the updated create_workspace_with_owner function - FIXED VERSION
...
-- Recreate with additional profile parameters and correct function calls
...
BEGIN
  ...
  -- Set up default rewards using the correct function name
  PERFORM public.create_default_rewards_v2(v_workspace_id);
  
  -- Set up default badges using the correct function name
